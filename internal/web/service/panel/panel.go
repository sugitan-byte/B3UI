...
const (
	panelUpdaterURL      = "https://raw.githubusercontent.com/sugitan-byte/B3UI/main/update.sh"
...
func fetchPanelRelease(tag string) (*service.Release, error) {
	url := "https://api.github.com/repos/sugitan-byte/B3UI/releases/latest"
	if tag != "" {
		url = "https://api.github.com/repos/sugitan-byte/B3UI/releases/tags/" + tag
	}
