...
bash <(curl -Ls https://raw.githubusercontent.com/sugitan-byte/B3UI/main/install.sh) v3.4.0
```
...
```bash
XUI_NONINTERACTIVE=1 bash <(curl -Ls https://raw.githubusercontent.com/sugitan-byte/B3UI/main/install.sh)
```

دایرکتوری [`deploy/`](https://github.com/sugitan-byte/B3UI/tree/main/deploy) در مخزن
